@DATA
  ...
  FORK_CTR_COR	    DW	%010000001100110101, 8, 8, %010000011100110001, 0, 0, %000001001101010011, 2, 2, %000001001100010111, 6, 6, %010011001101000001, 8, 8, %010111001100000001, 0, 0, %110101001100010000, 2, 2, %110001011100010000, 6, 6
